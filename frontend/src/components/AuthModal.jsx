...
const s = {
  ...
  tab: { flex: 1, padding: "0.55rem", border: "none", background: "transparent", cursor: "pointer", borderRadius: "10px", fontWeight: "500", color: "#8b6070", fontSize: "0.88rem", transition: "all 0.15s" },
  tabActive: { background: "white", color: "#d4235e", boxShadow: "0 2px 8px rgba(0,0,0,0.08)" },

  input: { width: "100%", padding: "0.85rem 1.1rem", borderRadius: "12px", border: "1.5px solid #f0e4ea", marginBottom: "0.9rem", fontSize: "0.92rem", outline: "none", display: "block", boxSizing: "border-box", color: "#1c0f18", transition: "border-color 0.15s" },
