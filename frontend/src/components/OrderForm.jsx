        ...
        {step === 1 && (
          <div className="animate-fadeIn">
            <div style={s.header}>
              ...
              <p style={{ ...s.sub, color: c.muted }}>We'll email you a verification code</p>
            </div>
            ...
            <form onSubmit={goToStep2}>
              ...
              <label style={{ ...s.label, color: c.muted }}>Email Address * <span style={{ fontWeight: 400, fontSize: "0.72rem" }}>(code will be sent here)</span></label>
              <input style={{ ...s.input, background: c.inputBg, border: `1.5px solid ${c.inputBorder}`, color: c.text }}
          ...
          <div className="animate-fadeIn">
            ...
            {devCode && (
              <div style={{ background: "#fff8e1", border: "1px solid #ffe082", borderRadius: "12px", padding: "0.8rem 1rem", marginBottom: "1rem", textAlign: "center" }}>
                <p style={{ color: "#5d4037", fontSize: "0.74rem", fontWeight: "600", marginBottom: "0.3rem" }}>⚙️ DEV MODE — Gmail not configured yet</p>
            ...
            <div style={{ ...s.smsNote, color: c.muted }}>
              💡 Didn't get it? Check your spam folder, or click Resend
            </div>
          </div>
        )}
      </div>
